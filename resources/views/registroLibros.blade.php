...
@section('contenido')
    ...
    <div class="cont-form cont-login cont-form-libros">
        <form method="POST" action="{{ route('libros.store') }}" class="form-alumnos form-libros">
            ...
            <input type="text" value="{{ old('titulo') }}" class="input-alumno rewidth" name="titulo" placeholder="Titulo">
            ...
            <div class="div-nombre_apellido">
                ...
                <div>
                    <input type="text" value="{{ old('autor') }}" class="input-alumno " name="autor"
                        placeholder="Autor">
            ...
            <input type="file" value="{{ old('imagen') }}" class="input-alumno rewidth file-input" name="imagen"
